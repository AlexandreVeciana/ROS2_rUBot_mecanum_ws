...
class WallFollower(Node):
    def __init__(self):
        ...
        self.declare_parameter('tolerance', 0.07)        # band around base_distance (RIGHT)
...
# ros2 launch my_robot_control my_robot_wallfollower_custom.launch.xml time_to_stop:=50.0
