...
class RobotSelfControl(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('distance_laser', 0.2)
    ...
    def laser_callback(self, scan):
        ...
        # Determine zone
        if -25 <= angle_closest_deg <= 25:
            zone = "FRONT"
        elif 65 < angle_closest_deg <= 115:
            zone = "LEFT"
        elif -115 <= angle_closest_deg < -65:
            zone = "RIGHT"
        elif 155 <= angle_closest_deg < -155:
            zone = "BACK"
        elif 115 < angle_closest_deg <= 155:
            zone = "BACK_LEFT"
        elif -155 <= angle_closest_deg < -115:
            zone = "BACK_RIGHT"
        elif 25 < angle_closest_deg <= 65:
            zone = "FRONT_LEFT"
        elif -65 <= angle_closest_deg < -25:
            zone = "FRONT_RIGHT"
